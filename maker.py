...
def requirements_use_to():
    ...
    print("Стамина")
    sp_use_to = str(input())
    nothingGiver(sp_use_to)
    print("Колдовство")
    mp_use_to = str(input())
    nothingGiver(mp_use_to)
    print("Интелект")
    ip_use_to = str(input())
    nothingGiver(ip_use_to)
    print("Сила")
    pp_use_to = str(input())
    nothingGiver(pp_use_to)
    print("Ловкость")
    ap_use_to = str(input())
    nothingGiver(ap_use_to)
    print("Вера")
    fp_use_to = str(input())
    nothingGiver(fp_use_to)
    print("Удача")
    lp_use_to = str(input())
    nothingGiver(lp_use_to)
    print("Харизма")
    cp_use_to = str(input())
    nothingGiver(cp_use_to)
    print("Рассудок")
    bp_use_to = str(input())
    nothingGiver(bp_use_to)

    print("\n" + "Введите требования для экипировки и использования артефакта связанные с очками умений: ")
    print("Пирокинектика")
    fire_access_use_to_thing = str(input())
    nothingGiver(fire_access_use_to_thing)
    print("Гидрософистика")
    water_access_use_to_thing = str(input())
    nothingGiver(water_access_use_to_thing)
    print("Аэрософистика")
    wind_access_use_to_thing = str(input())
    nothingGiver(wind_access_use_to_thing)
    print("Геомантия")
    dirt_access_use_to_thing = str(input())
    nothingGiver(dirt_access_use_to_thing)
    print("Киловактика")
    lightning_access_use_to_thing = str(input())
    nothingGiver(lightning_access_use_to_thing)
    print("Элафриситка")
    holy_access_use_to_thing = str(input())
    nothingGiver(holy_access_use_to_thing)
    print("Катифристика")
    curse_access_use_to_thing = str(input())
    nothingGiver(curse_access_use_to_thing)
    print("Гематомантия")
    bleed_access_use_to_thing = str(input())
    nothingGiver(bleed_access_use_to_thing)
    print("Ботаника")
    nature_access_use_to_thing = str(input())
    nothingGiver(nature_access_use_to_thing)
    print("Псифистика")
    mental_access_use_to_thing = str(input())
    nothingGiver(mental_access_use_to_thing)
    print("Владение навыками Колющего оружия")
    twohanded_access_use_to_thing = str(input())
    nothingGiver(twohanded_access_use_to_thing)
    print("Владение навыками Режущего оружия")
    polearm_access_use_to_thing = str(input())
    nothingGiver(polearm_access_use_to_thing)
    print("Владение навыками Дробящего оружия")
    onehanded_access_use_to_thing = str(input())
    nothingGiver(onehanded_access_use_to_thing)
    print("Владение навыками Двуручного оружия")
    stabbing_access_use_to_thing = str(input())
    nothingGiver(stabbing_access_use_to_thing)
    print("Владение навыками Древкового оружия")
    cutting_access_use_to_thing = str(input())
    nothingGiver(cutting_access_use_to_thing)
    print("Владение навыками Одноручного оружия")
    crushing_access_use_to_thing = str(input())
    nothingGiver(crushing_access_use_to_thing)
    print("Владение навыками Стрелкового оружия")
    small_arms_access_use_to_thing = str(input())
    nothingGiver(small_arms_access_use_to_thing)
    print("Владение навыками щитов")
    shields_access_use_to_thing = str(input())
    nothingGiver(shields_access_use_to_thing)

    print("\n" + "Введите очки экипировки и использования, занимаемые артефактом: ")
    print("Шлем")
    helmet_status_use_to_thing = str(input())
    nothingGiver(helmet_status_use_to_thing)
    print("Нагрудник")
    chest_status_use_to_thing = str(input())
    nothingGiver(chest_status_use_to_thing)
    print("Ботинки")
    shoes_status_use_to_thing = str(input())
    nothingGiver(shoes_status_use_to_thing)
    print("Наручи")
    gloves_status_use_to_thing = str(input())
    nothingGiver(gloves_status_use_to_thing)
    print("Предметы экипировки")
    item_slot_use_to_thing = str(input())
    nothingGiver(item_slot_use_to_thing)
